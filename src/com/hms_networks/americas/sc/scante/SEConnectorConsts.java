...
/**
 * Class of constants for the Ewon Scante Connector.
 *
 * @author HMS Networks, MU Americas Solution Center
 * @since 1.0
 */
public class SEConnectorConsts {
  // Connector Information
  /** Name of the connector application */
  public static final String CONNECTOR_NAME = "Ewon Scante Connector";
   ...
   * timeouts.
   */
  public static final String HTTP_TIMEOUT_SECONDS_STRING = "6";
  ...
  public static final int QUEUE_DATA_POLL_MIN_MEMORY_BYTES = 10000000;
  ...
  public static final String CONNECTOR_CONTROL_TAG_NAME = "ScanteControl";
  ...
  public static final String CONNECTOR_CONFIG_FILE_NAME = "ScanteConnectorConfig.json";
  /** The indent factor used in the JSON configuration file. */
  public static final int CONNECTOR_CONFIG_JSON_INDENT_FACTOR = 3;

  // Config Keys
  /** The configuration file JSON key for the Scante URL. */
  public static final String CONNECTOR_CONFIG_SCANTE_URL_KEY = "ScanteURL";
  /** The configuration file JSON key for the Scante destination */
  public static final String CONNECTOR_CONFIG_SCANTE_DEST_KEY = "ScanteDestination";
  /** The configuration file JSON key for the scante token key. */
  public static final String CONNECTOR_CONFIG_SCANTE_TOKEN_KEY = "ScanteToken";
  /** The configuration file JSON key for the scante app id. */
  public static final String CONNECTOR_CONFIG_SCANTE_APPID_KEY = "ScanteAppID";
  /** The configuration file JSON key for the scante pull id. */
  public static final String CONNECTOR_CONFIG_SCANTE_PULLID_KEY = "ScantePullID";
  ...
  // Config Defaults
  /** The default value for the Scante server URL */
  public static final String CONNECTOR_CONFIG_DEFAULT_SCANTE_URL_KEY =
      "http://apiv4-production.productious.com/PullDataDefinitions/";
  /** The default value for the Scante destination */
  public static final String CONNECTOR_CONFIG_DEFAULT_SCANTE_DEST = "/flexy_direct";
  ...
  /** The default value for the scante token in the configuration file. */
  public static final String CONNECTOR_CONFIG_DEFAULT_SCANTE_TOKEN =
      "519631107be5441aa0fb371b10409662";
  /** The default value for the scante app id in the configuration file. */
  public static final String CONNECTOR_CONFIG_DEFAULT_SCANTE_APPID =
      "cc6ad1db592e40c9af15628e2640ec23";
  /** The default value for the scante app id in the configuration file. */
  public static final String CONNECTOR_CONFIG_DEFAULT_SCANTE_PULLID = "Set-This-Value";
  ...
  // API Constants
  /** Date format for time stamps sent to the SCANTE API. */
  public static final SimpleDateFormat SCANTE_API_DATE_FORMAT =
      new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ssZ");
  /**
   * The path to the Scante REST API endpoint that is configured to accept data from this connector.
   */
  public static final String SCANTE_API_TAKE_INFO_ENDPOINT =
      "/Scante/Things/ConnectorHost/Services/TakeInfo";
